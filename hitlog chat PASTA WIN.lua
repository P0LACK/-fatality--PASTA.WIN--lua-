...
local textbox = gui.add_textbox("Prefix", "LUA>TAB B")
local Prefixcolr = gui.add_combo("Prefix color", "LUA>TAB B", {"white", "darkred", "team", "green" ,"lightgreen" , "lime", "red", "grey", "yellow", "bluegrey", "blue", "darkblue", "purple", "violet", "lightred", "orange"})
local textclr = gui.add_combo("Text Color", "LUA>TAB B", {"white", "darkred", "team", "green" ,"lightgreen" , "lime", "red", "grey", "yellow", "bluegrey", "blue", "darkblue", "purple", "violet", "lightred", "orange"})
local misscolor = gui.add_combo("Miss Color", "LUA>TAB B", {"white", "darkred", "team", "green" ,"lightgreen" , "lime", "red", "grey", "yellow", "bluegrey", "blue", "darkblue", "purple", "violet", "lightred", "orange"})
function on_shot_registered(shot)
    ...
    local Colors = {gui.get_combo_items("LUA>TAB B>Prefix color")}
